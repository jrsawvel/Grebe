...
my $query_string = "/?user_name=$user_name&user_id=$user_id&session_id=$session_id&action=delete";
...
ok($rc >= 200 && $rc < 300 , 'post was successfully deleted  by author.');

open($fh, ">", "t/deleted-post-info.json") or die "cannot open > deleted-post-info.json for read: $!";
